...
$rules_of_commenting = esc_html__( 'Please do not use offensive vocabulary.', 'aurum' );
...
add_filter( 'comment_form_defaults', 'aurum_comment_form_default_fields_wrap', 10000 );
/*
