...
<form class="woocommerce-shipping-calculator" action="<?php echo esc_url( wc_get_cart_url() ); ?>" method="post">
	...
	<p><a href="#" class="shipping-calculator-button button button-block button-large button-gray"><?php esc_html_e( 'Calculate shipping', 'woocommerce' ); ?></a></p>
	...
	<section class="shipping-calculator-form" style="display:none;">
		...
		<p><button type="submit" name="calc_shipping" value="1" class="button button-large button-block"><?php esc_html_e( 'Update totals', 'woocommerce' ); ?></button></p>
