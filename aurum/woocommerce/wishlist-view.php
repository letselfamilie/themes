    ...
    ?>
        ...
        <?php if( $is_custom_list ): ?>
            <div class="hidden-title-form">
                <input type="text" class="form-control" value="<?php echo $page_title ?>" name="wishlist_name"/>
                <button>
                    ...
                    <tr id="yith-wcwl-row-<?php echo $item['prod_id'] ?>" data-row-id="<?php echo $item['prod_id'] ?>">
                        ...
                        <td class="product-thumbnail">
                            <a href="<?php echo esc_url( get_permalink( apply_filters( 'woocommerce_in_cart_product', $item['prod_id'] ) ) ) ?>">
                                <?php echo aurum_image_placeholder_wrap_element( $product->get_image( aurum_woocommerce_get_cart_image_size() ) ); ?>
                            </a>
                        </td>
