...
function laborator_custom_css_page() {
	...
	if ( function_exists( 'wp_enqueue_code_editor' ) ) {
		...
		if ( isset( $_GET['tab'] ) ) {
			$tab = $_GET['tab'];
			if ( in_array( $tab, array( 'less', 'sass' ) ) ) {
				$mode = 'less' == $tab ? 'text/x-less' : $tab;
			}
		}
...
?>
<!-- Ace editor (if wordpress editor is available use that) -->
		...
		jQuery( document ).ready( function( $ ) {
			...
			$( selector ).each( function( i, textarea ) {
				...
				if ( function_exists( 'wp_enqueue_code_editor' ) ) : 
					...
					?>
					wp.codeEditor.initialize( textarea, <?php echo json_encode( $editor_settings ); ?> );
					<?php 
...
<style>
	...
	.ace-editor-textarea .CodeMirror {
		height: auto;
	}
	
	.ace-editor-textarea .CodeMirror-scroll {
		min-height: 600px;
	}
	
	.ace-editor-textarea--small .CodeMirror-scroll {
		min-height: 200px;
	}
</style>
...
<div class="wrap">
	...
	<form method="post">
		<div class="ace-editor-textarea">
			<textarea class="large-text code" id="laborator_custom_css" name="laborator_custom_css" cols="70" rows="30"><?php echo $custom_css; ?></textarea>
		</div>
	...
	<form method="post">
		...
		<div class="ace-editor-textarea ace-editor-textarea--small">
			<textarea class="large-text code" id="laborator_custom_css_lg" name="laborator_custom_css_lg" cols="70" rows="30"><?php echo $custom_css_lg; ?></textarea>
		</div>
		...
		<div class="ace-editor-textarea ace-editor-textarea--small">
			<textarea class="large-text code" id="laborator_custom_css_md" name="laborator_custom_css_md" cols="70" rows="30"><?php echo $custom_css_md; ?></textarea>
		</div>
		...
		<div class="ace-editor-textarea ace-editor-textarea--small">
			<textarea class="large-text code" id="laborator_custom_css_sm" name="laborator_custom_css_sm" cols="70" rows="30"><?php echo $custom_css_sm; ?></textarea>
		</div>
		...
		<div class="ace-editor-textarea ace-editor-textarea--small">
			<textarea class="large-text code" id="laborator_custom_css_xs" name="laborator_custom_css_xs" cols="70" rows="30"><?php echo $custom_css_xs; ?></textarea>
		</div>
	...
	<form method="post">
		<div class="ace-editor-textarea">
			<textarea class="large-text code" id="laborator_custom_css_less" name="laborator_custom_css_less" cols="70" rows="30"><?php echo $custom_css_less; ?></textarea>
		</div>
		<button type="submit" class="button button-primary save" name="save_changes">Save Changes</button>
	</form>
	...
	<form method="post">
		<div class="ace-editor-textarea">
			<textarea class="large-text code" id="laborator_custom_css_sass" name="laborator_custom_css_sass" cols="70" rows="30"><?php echo $custom_css_sass; ?></textarea>
		</div>
		<button type="submit" class="button button-primary save" name="save_changes">Save Changes</button>
	</form>
